...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.BRmzMEVV.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.D_mH_VVH.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js", "_app/immutable/chunks/entry.DCLdwHKa.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.CMq38I0D.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.BWzNsS0s.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    imports5 = ["_app/immutable/nodes/4.xcl05lt_.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});
...
function layout({
  ...
  const _images = images.map((image, index7) => {
    return {
      ...image,
      index: index7,
...
var Img, dijkstra, css, Gallery, Page4;
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/work/photography/_page.svelte.js"() {
    ...
    Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="masonry svelte-6b2t9q"><div class="${["container svelte-6b2t9q", "hidden"].join(" ").trim()}" style="${"width: " + escape(width, true) + "px"}">${each(scaledImages, ({ index: index7, ratio: ratio2, scaledHeight, scaledWidth, isLastInRow, isLastRow, scaledWidthPc, ...image }) => {
        return `<div class="image svelte-6b2t9q"${add_attribute(
          ...
          0
        )}>${slots.default ? slots.default({ index: index7, image }) : ` ${validate_component(imageComponent || missing_component, "svelte:component").$$render($$result, Object.assign({}, image), {}, {})} `} </div>`;
      })}</div></div>`;
    });
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const images = [
        {
          src: "/portfolio/SaltPonds/1-_DSC9404.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/1-DSC08756.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/2-_DSC9111.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/2-DSC08748.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/3-_DSC9099.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/3-DSC08723.jpg",
          width: 1365,
          height: 2048
        },
        {
          src: "/portfolio/SaltPonds/4-DSC07982.jpg",
          width: 2048,
          height: 1365
        }
      ];
      return `${$$result.head += `<!-- HEAD_svelte-1hjudnz_START --><link rel="stylesheet" href="/css/gallery.css"><!-- HEAD_svelte-1hjudnz_END -->`, ""} <input type="checkbox" id="main-navigation-toggle" class="btn btn--close" title="Toggle main navigation"> <label for="main-navigation-toggle" data-svelte-h="svelte-1bajy75"><span>menu</span></label> <nav id="main-navigation" class="nav-main" data-svelte-h="svelte-9d8csz"><ul class="menu"><li class="menu__item"><a class="menu__link" href="/">Home</a></li> <li class="menu__item"><span class="menu__link menu__parent">Work</span> <ul class="submenu"><li class="menu__item"><a class="menu__link" href="/work/photography">Alviso Salt Ponds</a></li></ul></li> <li class="menu__item"><a class="menu__link" href="/about">About</a></li> <li class="menu__item"><a class="menu__link" href="/contact">Contact</a></li></ul></nav> <main class="page-container" data-svelte-h="svelte-i9yb8x"><h1 class="center">Alviso Salt Ponds</h1></main> <div class="after-page">${validate_component(Gallery, "Gallery").$$render($$result, { images, rowHeight: 600 }, {}, {})} <iframe src="https://www.youtube.com/watch?v=jfKfPfyJRdk&pp=ygUEbG9maQ%3D%3D" frameborder="0"></iframe></div>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    imports6 = ["_app/immutable/nodes/5.CJA9DjJZ.js", "_app/immutable/chunks/scheduler.D1CqcpTR.js", "_app/immutable/chunks/index.DeGntEyt.js"];
    stylesheets6 = ["_app/immutable/assets/5.BqwnsGb-.css"];
    fonts6 = [];
  }
});
